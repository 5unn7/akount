import { FileText, MoreVertical, Check, Clock, AlertCircle } from 'lucide-react'
...
export function BillRow({
  ...
  const formattedIssueDate = new Date(bill.issueDate).toLocaleDateString('en-US', {
    month: 'short',
    day: 'numeric',
    year: 'numeric',
  })
    ...
    >
      <div className="grid grid-cols-12 gap-4 items-center">
        ...
        <div className="col-span-12 md:col-span-3">
          ...
          >
            <p className="text-sm font-bold text-violet-600 dark:text-violet-400 group-hover:text-violet-700 dark:group-hover:text-violet-300 transition-colors font-[family-name:var(--font-mono)]">
              {bill.billNumber}
            </p>
