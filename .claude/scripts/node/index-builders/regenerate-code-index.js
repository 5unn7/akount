...
const STATE_FILE = path.join(PROJECT_ROOT, '.claude/state/.code-index-state.json');
...
const DOMAINS = {
  ...
  'web-pages': {
    ...
    indexFile: '.claude/CODEBASE-WEB-PAGES.md',
  },
  'web-business': {
    name: 'WEB-BUSINESS',
    paths: [
    ...
    indexFile: '.claude/CODEBASE-WEB-BUSINESS.md',
  },
  'web-shared': {
    name: 'WEB-SHARED',
    paths: [
    ...
    indexFile: '.claude/CODEBASE-WEB-SHARED.md',
  },
  'web-forms': {
    name: 'WEB-FORMS',
    paths: [
    ...
    indexFile: '.claude/CODEBASE-WEB-FORMS.md',
  },
  packages: {
    name: 'PACKAGES',
    paths: ['packages/**/*.ts', 'packages/**/*.tsx'],
    indexFile: '.claude/CODEBASE-PACKAGES.md',
  },
};
