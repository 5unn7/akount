...
const DOMAIN_INDEX_MAP = {
  banking: '.claude/CODEBASE-BANKING.md',
  invoicing: '.claude/CODEBASE-INVOICING.md',
  accounting: '.claude/CODEBASE-ACCOUNTING.md',
  planning: '.claude/CODEBASE-PLANNING.md',
  ai: '.claude/CODEBASE-AI.md',
  'web-pages': '.claude/CODEBASE-WEB-PAGES.md',
  'web-business': '.claude/CODEBASE-WEB-BUSINESS.md',
  'web-shared': '.claude/CODEBASE-WEB-SHARED.md',
  'web-forms': '.claude/CODEBASE-WEB-FORMS.md',
  packages: '.claude/CODEBASE-PACKAGES.md',
};
