...
const { loadEnrichments } = require('../../lib/load-enrichments');
...
// ─── Enrichment Data ────────────────────────────────────────────────
// (loadEnrichments now imported from lib/load-enrichments.js)
...
function printTaskRisk(task, enrichments, recentDomains) {
  ...
  if (risk > 60) {
    ...
    console.log('  2. Manually add acceptance criteria to .claude/state/task-enrichments/<domain>.json');
