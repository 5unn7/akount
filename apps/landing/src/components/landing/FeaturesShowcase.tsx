...
// 3D Scene Component
function ThreeScene({ Canvas, OrbitControls, Text }: { Canvas: React.ComponentType<any>; OrbitControls: React.ComponentType<any>; Text: React.ComponentType<any> }) {
...
export function FeaturesShowcase() {
  ...
  const [Text, setText] = useState<React.ComponentType<any> | null>(null);
  ...
  const use3D = !isMobile && webGLAvailable && Canvas && OrbitControls && Text;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {use3D ? (
          <div className="h-[500px] w-full">
            ...
            >
              <ThreeScene Canvas={Canvas} OrbitControls={OrbitControls} Text={Text} />
            </Suspense>
          </div>
        ) : (
          <Feature2DGrid />
