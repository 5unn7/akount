            ...
            {initialData && (
                <div className="space-y-6">
                    ...
                    <div className="glass rounded-xl p-6">
                        ...
                        <SimpleBarChart
                            data={[
                                { label: 'Assets', value: initialData.assets.total, color: 'var(--color-ak-blue)' },
                                { label: 'Liabilities', value: initialData.liabilities.total, color: 'var(--color-ak-red)' },
                                { label: 'Equity', value: initialData.equity.total, color: 'var(--color-ak-green)' },
                            ]}
