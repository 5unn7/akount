            ...
            <div className="grid grid-cols-2 gap-2">
                {ACTIONS.map((action) => (
                    <Link
                        key={action.label}
                        href={action.href}
                        className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg glass-2 hover:bg-ak-bg-3 hover:border-ak-border-2 hover:-translate-y-px transition-all text-sm text-muted-foreground hover:text-foreground"
                    >
