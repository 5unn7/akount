...
const MOCK_BILL_LINE = {
  ...
  amount: 12500, // Pre-tax line amount: qty * unitPrice (5 * 2500)
  glAccountId: null,
  categoryId: null,
  taxRateId: null,
};
...
describe('Bill Routes', () => {
      ...
      lines: [
        {
          ...
          unitPrice: 2500,
          taxAmount: 1625,
          amount: 12500, // Pre-tax: qty * unitPrice (5 * 2500)
        },
      ],
    };
  ...
  describe('GET /bills', () => {
    ...
    it('should return all entities when entityId is omitted', async () => {
      ...
      const callArgs = mockListBills.mock.calls[0][0];
