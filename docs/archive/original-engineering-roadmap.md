...
- [ ] Authentication (Clerk)
  ...
  - Passkey management UI (add, rename, remove)
    ...
    - **[NEW] Recovery Codes**: Generate generic recovery codes to prevent lockout (Phase 1 Critical)
  ...
  - **[NEW] Account Deletion**: GDPR "Right to Erasure" flow (Phase 1)
...
- [ ] Manual import fallbacks (critical for MVP)
  ...
  - **PDF Bank Statement Upload**: Upload PDF, OCR extraction, review, import
    ...
    - **[CRITICAL] Cost Control**: Usage limits (e.g., 50 pages/mo) enforced on Free Tier.
