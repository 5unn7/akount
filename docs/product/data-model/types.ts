 ...
 * 
 * IMPORTANT: All monetary amounts are stored as INTEGERS in the smallest currency unit (e.g., cents).
 * Example: $10.99 is stored as 1099.
 * Reasons: Avoid floating point errors (IEEE 754), simplify db storage, consistent math.
 */
...
export interface Transaction {
  ...
  journalEntryId?: string;
  /**
   * If true, this transaction is split into multiple lines/categories.
   * Review `splits` array for details.
   */
  isSplit?: boolean;
...
export interface TransactionSplit {
  ...
  description?: string;
  notes?: string;
  projectId?: string; // Optional project tagging
  tags?: string[];
  createdAt: string;
  updatedAt: string;
}
