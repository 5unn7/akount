...
| UX-34 | App-wide: Add bulk operations to list pages — batch send/approve invoices, batch approve bills, batch deactivate accounts | 3-4h | 🟡 Medium | 📦 | | audit:app-ux |
...
| TEST-9 | Frontend: Create mock data factories (Account, Invoice, etc.) | 45m | 🟠 High | 🟢 | | plan:frontend-test-coverage |
| TEST-10 | Frontend: Create API mock helpers (typed apiFetch wrappers) | 30m | 🟠 High | 🟢 | | plan:frontend-test-coverage |
| TEST-11 | Frontend: Test currency.ts (4 functions, ~20 tests) | 45m | 🟠 High | 🟢 | | plan:frontend-test-coverage |
| TEST-12 | Frontend: Test date.ts (4 functions, ~15 tests) | 45m | 🟠 High | 🟢 | | plan:frontend-test-coverage |
| TEST-13 | Frontend: Test account-helpers.ts (2 functions + maps, ~15 tests) | 45m | 🟡 Medium | 🟢 | | plan:frontend-test-coverage |
| TEST-14 | Frontend: Test StatCard / QuickStats / QuickActionPills | 1.5h | 🟡 Medium | 🟢 | [needs: TEST-8] | plan:frontend-test-coverage |
| TEST-15 | Frontend: Test DashboardMetrics + EntityAccountCards | 1.5h | 🟡 Medium | 🟢 | [needs: TEST-8,TEST-9,TEST-10] | plan:frontend-test-coverage |
| TEST-16 | Frontend: Test overview widgets (P&L, TrialBalance, TopRevenue) | 1.5h | 🟡 Medium | 🟢 | [needs: TEST-8,TEST-9,TEST-10] | plan:frontend-test-coverage |
| TEST-17 | Frontend: Test InvoiceTable + BillsTable + PaymentTable | 2h | 🟡 Medium | 🟢 | [needs: TEST-8,TEST-9] | plan:frontend-test-coverage |
| TEST-18 | Frontend: Test ClientForm + VendorForm | 2h | 🟡 Medium | 🟢 | [needs: TEST-8,TEST-9,TEST-10] | plan:frontend-test-coverage |
