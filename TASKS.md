...
| ~~INFRA-16~~ | ~~Upgrade markdownlint-cli2 to fix markdown-it ReDoS (0.20.0 → 0.21.0+)~~ | 15m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-17~~ | ~~Upgrade eslint to v10 to fix minimatch ReDoS (8.57.1 → 10.0.1, flat config)~~ | 30m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-18~~ | ~~Verify dev dependency fixes (markdown-it resolved, minimatch in transitive deps)~~ | 10m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-19~~ | ~~Install exceljs@4.4.0 and remove vulnerable xlsx@0.18.5~~ | 10m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-20~~ | ~~Migrate parseXLSX to async exceljs API (apps/api/src/domains/banking/services/parser-csv.ts)~~ | 1-2h | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-21~~ | ~~Verify XLSX magic bytes detection still works (no code change needed)~~ | 15m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-22~~ | ~~Update parseXLSX tests for exceljs async API (all pass)~~ | 30m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-23~~ | ~~Update XLSX import route tests (21/21 tests pass)~~ | 30m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-24~~ | ~~Update file scanner tests (18/18 tests pass)~~ | 30m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-25~~ | ~~Run full test suite (1133/1133 tests pass)~~ | 10m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-26~~ | ~~Type check (maintained 0 TypeScript errors)~~ | 5m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-27~~ | ~~Final npm audit (xlsx resolved, 19 minimatch in dev/archiver accepted)~~ | 5m | 🟠 High | ✅ | 276661d | plan:npm-audit |
| ~~INFRA-28~~ | ~~Update MEMORY.md Known Issues (updated npm vulnerabilities status)~~ | 5m | 🟠 High | ✅ | 276661d | plan:npm-audit |
...
| ~~DEV-95~~ | ~~Business: Add client invoice history tab~~ (merged into DEV-122) | 2-3h | 🟡 Medium | ✅ | | audit:fe-be-parity |
| ~~DEV-96~~ | ~~Business: Add vendor bill history tab~~ (merged into DEV-123) | 2-3h | 🟡 Medium | ✅ | | audit:fe-be-parity |
...
| ~~DEV-123~~ | ~~Business: Add vendor detail page `/business/vendors/[id]` — contact info, stats summary, bill history tab, edit capability (API `GET /vendors/:id` + `PUT` exist). Absorbs DEV-96 + UX-37 (vendor portion)~~ | 3-4h | 🟡 Medium | ✅ | session | sitemap:audit |
