...
> **153 active tasks** · 🔴 2 critical · 🟠 22 high · 🟡 102 medium · ⚪ 27 low
> 📦 115 backlog · 🟢 31 ready · 🔒 6 blocked · 🟡 1 deferred
>
...
| ~~SEC-39~~ | ~~Add userId authentication checks to 5 onboarding routes~~ | 1h | 🔴 Critical | ✅ | | audit:2026-02-26 |
| SEC-8 | Complete security audit (OWASP top 10, auth, tenant isolation, input validation) | 4h | 🟠 High | 🟡 deferred | | roadmap |
| ~~PERF-23~~ | ~~Fix AI batch approval/rejection N+1 queries (batch fetch + batch update)~~ | 4-6h | 🟠 High | ✅ | | audit:2026-02-26 |
| ~~PERF-24~~ | ~~Add composite indexes for pagination (100x speedup)~~ | 2h | 🟠 High | ✅ | | audit:2026-02-26 |
...
| ~~SEC-41~~ | ~~Replace CORS wildcard in dev with explicit whitelist~~ | 1h | 🟠 High | ✅ | | audit:2026-02-26 |
| ~~ARCH-9~~ | ~~Configure Prisma connection pool documentation~~ | 1h | 🟠 High | ✅ | | audit:2026-02-26 |
...
{
  "version": "1.0",
  "generated": "2026-02-26T21:28:18.073Z",
  "summary": {
    "total": 153,
    "ready": 31,
    "blocked": 6,
  ...
  "tasks": {
    ...
    "SEC-39": {
      "line": 29,
      "title": "Add userId authentication checks to 5 onboarding routes (/initialize, /complete, /status, /save-step, /resume)",
      "effort": "1h",
      "priority": "critical",
      "status": "ready",
      "deps": [],
    ...
    "PERF-23": {
      "line": 31,
      "title": "Fix AI batch approval/rejection N+1 queries (batch fetch + batch update instead of loops)",
      "effort": "4-6h",
      "priority": "high",
      "status": "ready",
      "deps": [],
    ...
    "PERF-24": {
      "line": 32,
      "title": "Add composite indexes (Transaction.accountId+createdAt, AuditLog.tenantId+createdAt, Invoice/Bill.status+createdAt)",
      "effort": "2h",
      "priority": "high",
      "status": "ready",
      "deps": [],
    ...
    "SEC-41": {
      "line": 35,
      "title": "Replace CORS wildcard in dev with explicit whitelist (localhost:3000, localhost:3001)",
      "effort": "1h",
      "priority": "high",
      "status": "ready",
      "deps": [],
    ...
    "ARCH-9": {
      "line": 36,
      "title": "Configure Prisma connection pool (set connection_limit=50, pool_timeout=30)",
      "effort": "1h",
      "priority": "high",
      "status": "ready",
      "deps": [],
    ...
    "TEST-21": {
      "line": 61,
      "title": "Fix 8 TypeScript errors (3 web + 5 API test files)",
      "effort": "2h",
      "priority": "medium",
      "status": "ready",
      "deps": [],
